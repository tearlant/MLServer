...
namespace DeepServices
{
    ...
    public class PredictionService<T, S> : SessionHandlerBase, IPredictionService<T, S> where T : class, new() where S : class, new()
    {
        ...
        public PredictionService(IHttpContextAccessor httpContextAccessor, IOptions<PredictionServiceCachingOptions> cachingOptions, ILogger<PredictionService<T, S>> logger) : base(httpContextAccessor, TimeSpan.FromMinutes(20), TimeSpan.FromMinutes(10))
        {
